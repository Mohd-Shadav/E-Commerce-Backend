...
function Signup() {
  ...
  const handleSubmit = async(e)=>{
   ...
   try{
     const data = await axios.post("http://localhost:3000/api/admin/create-admin",credentials,{
...
<form  className={styles.form}>
    <h2 style={{textAlign:"center"}}>Create ADMIN</h2>
      ...
      <div className={styles.inputForm}>
        ...
        <input placeholder="Enter your Name" className={styles.input} type="text" name="name" onChange={handleChange}  value={credentials.name}  style={{ backgroundColor: 'transparent' }}/>
      </div>
    <div className={styles["flex-column"]}>
    ...
    <button onClick={handleSubmit} className={styles["button-submit"]}>Sign Up</button>
